...
namespace _4D_function
{
    class d4
    {
        ...
        static void draw_line_col(d4 point1, d4 point2, PictureBox p, Graphics g, Color col)
        {
            Pen pn = new Pen(col);
            g.DrawLine(pn, (float)point1.X + p.Width / 2, (float)point1.Y + p.Height / 2, (float)point2.X + p.Width / 2, (float)point2.Y + p.Height / 2);
        }
        public static void draw_basis(PictureBox p, Graphics g)
        {
            ...
            draw_line_col(zero, x, p, g, Color.Red);
            draw_line_col(zero, y, p, g, Color.Green);
            draw_line_col(zero, z, p, g, Color.Blue);
            draw_line_col(zero, t, p, g, Color.Violet);
